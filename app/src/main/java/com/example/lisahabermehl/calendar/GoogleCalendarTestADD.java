...
public class GoogleCalendarTestADD extends Activity implements EasyPermissions.PermissionCallbacks {
    ...
    public void getResultsFromApi() {
        if (! isGooglePlayServicesAvailable()) {
            ...
            if (passing[0].equals("add")) {
                passing[1] = extras.getString("one");
                Log.d("PASS ZERO", passing[0]);
                Log.d("PASS ONE", passing[1]);
                passing[2] = extras.getString("two");
                passing[3] = extras.getString("three");
                Log.d("PASS TWO", passing[2]);
                Log.d("PASS THREE", passing[3]);
            }
        ...
        protected String doInBackground(String... params) {
            if (params[0].equals("add")) {
                ...
                try {
                    ...
                    Log.d("End datetime", String.valueOf(startDateTime));
